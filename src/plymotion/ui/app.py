...
Galería, Sistema, Login, and Restaurar views together through a shared AppContext."""
...
from plymotion.ui.views.login_view import build_login_view
...
async def main(page: ft.Page) -> None:
    ...
    login_control = build_login_view(ctx)
    restore_control = build_restore_view(ctx)
    views = [convert_control, gallery_control, system_control, login_control, restore_control]
